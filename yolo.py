...
if tfVersion >1:
    from tensorflow.keras.layers import Conv2D, Input, BatchNormalization, LeakyReLU, ZeroPadding2D, UpSampling2D, Lambda, Layer
...
class YoloLayer(Layer):
    ...
    def call(self, x):
        ...
        Warm-up training
        """
        self.batch_seen = self.batch_seen.assign_add(1.)
        
        true_box_xy, true_box_wh, xywh_mask = tf.cond(tf.less(self.batch_seen, self.warmup_batches+1),
